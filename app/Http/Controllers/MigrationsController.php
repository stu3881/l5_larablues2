...
class MigrationsController extends CRHBaseController
{
        ...
        $controller_name                = "MigrationsController", 
        $model_table                    = "migrations",         
        $model                          = "Migration", 
        $node_name                      = "migrations", 
    ...
    // ****************
        ...
        switch ($distinct_regular) { 
            ...
            case "distinct":
                $query = Migration::distinct()->select($field_name);
                echo("Migration::distinct()->select(".$field_name.")");
                break;
            case "regular":
                $query = Migration::where($field_name,$r_o,$v);
                echo("Migration::where(".$field_name.",". $r_o. ",".$v.")");
                break;
       }   
       return $query;
    }
    ...
    public function kloneRecord($function,$id)    {
        switch ($function) {
             case "insert":
                //$this->debugx('1111',__FILE__,__LINE__,__FUNCTION__);
                $data_record = Migration::where('id','=',$id)->get();
        ...
        if (!empty($what_we_are_doing)) {
            ...
            switch ($what_we_are_doing) { 
                ...
                // *****
                        ...
                        return view('migrations'.'.editUpdate',compact('miscThings'))
                        ->with('node_name'   ,$this->node_name)            
                        ->with('model'   ,$this->model)            
    ...
    public function model_get_id($model,$id){
        ...
        switch ($model) {
            ...
            case $this->model:
                ...
                //$this->debugx('0111',__FILE__,__LINE__,__FUNCTION__);
                $model_get_id = Migration::where('id','=',$id)  
                ->get();
                break;
         }
        ...
        if ($update){  
            ...
            switch ($what_we_are_doing) {
                ...
                case 'updating_report_name':
                    switch ($coming_from) {
                        ...
                        case 'select_fields':
                           ...
                           return view('migrations'.'.reportDefMenuEdit',compact('miscThing'))
                            ->with('id'                    ,$id)
                ...
                case "ppv_define_business_rules":
                   ...
                   return redirect()->route('migrations.browseEdit', 
    ...
    public function updateGetRedirectold($key_field_name,$id,$requestFieldsArray,$request){
        ...
        $query_result = 'Migration'::where($key_field_name,  '=', $id)
        ->update($requestFieldsArray);
     ...
     public function destroyx($id)
    {
        ...
        $this->authorize('destroy', Migration);
