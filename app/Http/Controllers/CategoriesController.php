...
class CategoriesController extends CRHBaseController
{
    ...
    public function kloneRecord($function,$id)    {
        switch ($function) {
             case "insert":
                //$this->debugx('1111',__FILE__,__LINE__,__FUNCTION__);
                $data_record = Categorie::where('id','=',$id)->get();
        ...
        if (!empty($what_we_are_doing)) {
            ...
            switch ($what_we_are_doing) { 
                ...
                // *****
                        ...
                        return view('categories'.'.editUpdate',compact('miscThings'))
                        ->with('node_name'   ,$this->node_name)            
                        ->with('model'   ,$this->model)            
    ...
    public function model_get_id($model,$id){
        ...
        switch ($model) {
            ...
            case $this->model:
                ...
                //$this->debugx('0111',__FILE__,__LINE__,__FUNCTION__);
                $model_get_id = Categorie::where('id','=',$id)  
                ->get();
                break;
         }
        ...
        if ($update){  
            ...
            switch ($what_we_are_doing) {
                ...
                case 'updating_report_name':
                    switch ($coming_from) {
                        ...
                        case 'select_fields':
                           ...
                           return view('categories'.'.reportDefMenuEdit',compact('miscThing'))
                            ->with('id'                    ,$id)
                ...
                case "ppv_define_business_rules":
                   ...
                   return redirect()->route('categories.browseEdit', 
     ...
     public function destroyx($id)
    {
        ...
        $this->authorize('destroy', Categorie);
