...
class Users_bluesController extends CRHBaseController
{
        ...
        $controller_name                = "Users_bluesController", 
        $model_table                    = "users_blues",         
        $model                          = "Users_blue", 
        $node_name                      = "users_blues", 
    ...
    // ****************
        ...
        switch ($distinct_regular) { 
            ...
            case "distinct":
                $query = Users_blue::distinct()->select($field_name);
                echo("Users_blue::distinct()->select(".$field_name.")");
                break;
            case "regular":
                $query = Users_blue::where($field_name,$r_o,$v);
                echo("Users_blue::where(".$field_name.",". $r_o. ",".$v.")");
                break;
       }   
       return $query;
    }
    ...
    public function kloneRecord($function,$id)    {
        switch ($function) {
             case "insert":
                //$this->debugx('1111',__FILE__,__LINE__,__FUNCTION__);
                $data_record = Users_blue::where('id','=',$id)->get();
        ...
        if (!empty($what_we_are_doing)) {
            ...
            switch ($what_we_are_doing) { 
                ...
                // *****
                        ...
                        return view('users_blues'.'.editUpdate',compact('miscThings'))
                        ->with('node_name'   ,$this->node_name)            
                        ->with('model'   ,$this->model)            
    ...
    public function model_get_id($model,$id){
        ...
        switch ($model) {
            ...
            case $this->model:
                ...
                //$this->debugx('0111',__FILE__,__LINE__,__FUNCTION__);
                $model_get_id = Users_blue::where('id','=',$id)  
                ->get();
                break;
         }
        ...
        if ($update){  
            ...
            switch ($what_we_are_doing) {
                ...
                case 'updating_report_name':
                    switch ($coming_from) {
                        ...
                        case 'select_fields':
                           ...
                           return view('users_blues'.'.reportDefMenuEdit',compact('miscThing'))
                            ->with('id'                    ,$id)
                ...
                case "ppv_define_business_rules":
                   ...
                   return redirect()->route('users_blues.browseEdit', 
     ...
     public function destroyx($id)
    {
        ...
        $this->authorize('destroy', Users_blue);

        Users_blue::delete($id);
