...
<td style="text-align:left">
{{ Form::text('v_assign',$record['v_assign']) }}
</td>
<tr>
<td style="text-align:left">
...
<td style="text-align:left">
{{ Form::text('v_flag',$record['v_flag']) }}
</td>
<tr>
<td style="text-align:left">
...
<tr>
<td style="text-align:left">
{{ Form::label('abc','or add a new value for v_notes') }}
</td>
<td style="text-align:left">
{{ Form::text('new_v_notes','') }}
</td>
<tr>
<td style="text-align:left">
...
<td style="text-align:left">
{{ Form::text('v_phone',$record['v_phone']) }}
</td>
