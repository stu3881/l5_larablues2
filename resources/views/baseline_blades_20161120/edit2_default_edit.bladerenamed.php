...
<?php 
	...
	//var_dump(Input::all());var_dump($passed_to_view_array);//exit("edit2_default_edit exit 24"); 	
...
<div id="admin" style="width:750px">
	...
	<br>
		...
		{{ Form::open(array('url'=>'admin/'.$node_name.'/edit2new', 'method'=>'PUT','class'=>'table_inside_update_active_tasks')) }}
		{{ Form::hidden('node_name'							,$node_name) }}
		{{ Form::hidden('coming_from'						,Input::get('coming_from')) }}
		{{ Form::hidden('data_key'							,Input::get('data_key')) }}
		{{ Form::hidden('encoded_business_rules_field_name_array'							,Input::get('encoded_business_rules_field_name_array')) }}
		{{ Form::hidden('encoded_business_rules_r_o_array'							,Input::get('encoded_business_rules_r_o_array')) }}
		{{ Form::hidden('encoded_business_rules_value_array'							,Input::get('encoded_business_rules_value_array')) }}
		...
		{{ Form::submit(Input::get("add_update_button_name")) }}
		{{ Form::close() }}
					</td>
...
--> 
			...
			<td>
				...
				@include("../".$passed_to_view_array['report_definition']->node_name.'/'.$generated_files_folder.'/'.Input::get('report_key').'_snippet_string')
