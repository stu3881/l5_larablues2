...
// *******
	...
	//var_dump($report_definition);//$key_field_name = $key_field_name;  //passed in
	//echo("../ ".$report_definition->node_name.' / '.$generated_files_folder.' / '.$report_key.' _browse_select_field_names_row ');
	...
	<tbody>
		...
		<td colspan=5{{--$browse_select_field_count--}} >	
			...
			<tbody>
				...
				<td>	
					{{ Form::open(array('url'=>'admin/'.$report_definition->node_name.'/add', 'method'=>'GET')) }}
					{{ Form::hidden('key_field_name'			,$key_field_name) }}
		...
		?>
		<!--
			@include("../".$report_definition->node_name.'/'.$generated_files_folder.'/'.$report_key.'_browse_select_field_names_row')
		-->	
			...
			@foreach($all_records as  $record)
				...
				<tr >
					...
					@include("../".$report_definition->node_name.'/'.$generated_files_folder.'/'.$report_key.'_browse_select_display_snippet')
